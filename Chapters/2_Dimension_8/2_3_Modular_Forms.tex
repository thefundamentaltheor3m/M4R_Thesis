...
\begin{boxdefinition}[The $\Theta$- and $H$-Functions]
...
It can be shown that the $H$-functions are modular forms of weight $2$ and level $2$. In fact, $\set{H_2, H_3, H_4}$ is a basis for the space $M_2\of{\Gamma\of{2}}$.

Given the manner in which the $H$-functions are defined, it is tedious to compute their Fourier expansions explicitly. However, just as the purpose of computing the Fourier expansions of 
