...
We now state important properties of the $H$-functions. These have been taken from \cite[(13)-(19)]{Viazovska8} and \cite[\S 6]{blueprint}, though the notation used in \cite{Viazovska8} is slightly different ($\Theta_2$, $\Theta_3$ and $\Theta_4$ are denoted $\theta_{10}$, $\theta_{00}$ and $\theta_{01}$ respectively).\todo{Make sure we got these the right way round}
