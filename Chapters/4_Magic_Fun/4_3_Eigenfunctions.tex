...
\begin{proof}[Proof sketch]
    ...
    \end{enumerate}
    These easily follow from the arguments in \Cref{Ch4:Subec:Schwartzness_a}.
\end{proof}

\Cref{Ch4:Prop:FourierIntegralConvergence_Ij} allows us to swap integrals using Fubini's theorem to prove the eigenfunction property.
...
\begin{proof}
    ...
    \end{align*}
    by \eqref{Ch4:Eq:phi_0_add_one}. Note that $f$ is holomorphic (in $w$) on $\Halfplane$. \Cref{Ch4:Thm:CGTRectCircle} then tells us that
    \begin{align*}
        F_1\of{\xi}
