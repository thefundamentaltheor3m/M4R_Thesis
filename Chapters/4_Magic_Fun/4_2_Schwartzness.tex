...
At the end of \Cref{Ch4:Subsec:b_def}, we observed striking similarities between the $J_j$ and the $I_j$. As a result, much of the proof of Schwartzness is quite similar. We emphasise the aspects that differ but do not discuss the aspects that do not in too much detail.

We begin by proving an analogue of \Cref{Ch4:Lemma:PolyFourierCoeffBound_Apply_a}.
