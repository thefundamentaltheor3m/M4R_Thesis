...
\end{align}
The integrals for which this is not true purely by inspection are $J_2$ and $J_4$, because the integrands take a slightly different form. We can bound them nonetheless.
