...
\end{boxlemma}
\begin{proof}
    We begin by computing $n_0\of{H_2}$, $n_0\of{H_3}$ and $n_0\of{H_4}$. From \eqref{Ch2:Eq:H2_qexpansion_explicit}, we can see that $n_0\of{H_2} = 1$. Furthermore, from \Cref{Ch2:Def:Theta_H}, we can see that $n_0\of{\theta_3} = n_0\of{\theta_4} = 0$, from which we cn conclude that $n_0\of{H_3} = n_0\of{H_4} = 0$.
\end{proof}