...
% Modify figure caption style
\usepackage[labelsep=period]{caption}  % Adds period after figure number
\captionsetup{labelsep=period}         % Sets separator to period
\setlength{\belowcaptionskip}{-10pt}   % Reduces spacing after caption